...
const MobileAboutForum = () => {
    ...
    return (
        <>
            {topic !== undefined ?
                <div className='background-background px-[12px] py-[20px] flex flex-col justify-start items-start text-left w-full gap-[10px]'>
                    ...
                    {topic.linked ?
                        <div className='foreground w-full flex items-center justify-center relative'>
...
export default MobileAboutForum;