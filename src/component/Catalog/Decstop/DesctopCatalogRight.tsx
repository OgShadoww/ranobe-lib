            ...
            <div className='h-full foreground'>
                <div className='search-filter-wrap'>
                    <div className='main-wrapper-padding-out relative'>
                        <div className='px-[14px] py-[12px] flex justify-between items-center cursor-pointer rounded-[3px] border-base'>
                        ...
                        <input placeholder='Фільтр по жанрам' type="text" className='border-base text-[14px] outline-none placeholder:text-secondary text-primary px-[14px] py-[12px] h-[40px] input-background w-full' />
                    ...
                    <div className='absolute bottom-0 left-0 right-0 z-40 px-[13px] py-[6px] gap-[10px] flex'>
                        <button onClick={() => genreList = []} className='button-default-color button-default-bg min-h-[16px] text-[14px] font-[600] h-[36px] px-[16px] rounded-[3px] outline-none flex-1'>
                            Скинути
                        </button>
